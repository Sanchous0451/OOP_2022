...
class Hare: 
    ...
    def draw_body(self, surface): 
        ellipse(surface, self.color, (self.x - self.body_width // 2, self.body_y - self.body_height // 2, self.body_width, self.body_height)) 
...
hare = Hare(200, 200, 100, 200, pygame.Color('white')) 
while not finished: 
    clock.tick(FPS) 
